            ...
            child: Column(
              ...
              children: [
                ...
                _DrawerItem(
                  ...
                  label: 'TRENDING',
                  isActive: activePath.startsWith('/market'),
                  onTap: () {
                    context.go('/'); // Using root as per Sidebar
                    context.pop();
                  },
                ),
                _DrawerItem(
          ...
          child: SafeArea(
            ...
            child: Row(
              children: [
                ...
                const Spacer(),
                // Connect Wallet could go here if available as a widget
              ],
            ),
          ),
        ),
