...
class _PriceAiInsightsPanelState extends State<PriceAiInsightsPanel> {
  final List<String> _reasoningSteps = [
    'Scanning polling aggregator feeds...',
    'Cross-referencing prediction market liquidity...',
    'Analyzing on-chain sentiment flows...',
    'Evaluating historical outcome patterns...',
    'Computing fair value probability distribution...',
    'GAINR Neural Synthesis complete.',
  ];
        ...
        const Center(
          child: Column(
            children: [
              ...
              SizedBox(height: 24),
              NeonText(
                text: 'Running Political Analysis Engine...',
                style: TextStyle(
                  color: Colors.white,
                  fontSize: 15,
    ...
    return TweenAnimationBuilder<double>(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              _metricCard('Calculated Edge', '+${edge.toStringAsFixed(1)}%',
                  'EV Positive', AppColors.neonOrange),
              const SizedBox(width: 12),
              _metricCard('Confidence', '$confidence%',
                  edge > 5 ? 'High Quality' : 'Moderate', AppTheme.neonCyan),
            ],
          ),
          const SizedBox(height: 24),
