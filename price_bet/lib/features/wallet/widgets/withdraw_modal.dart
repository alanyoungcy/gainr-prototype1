  ...
  Future<void> _handleWithdraw() async {
    ...
    if (wallet.betBalance < amount) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Insufficient \$GBET balance'),
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'Burn \$GBET chips and receive USDC. 1 \$GBET = 1 USDC.',
                      style: TextStyle(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            NeonText(
                              text:
                                  'Available: ${wallet.betBalance.toStringAsFixed(2)} \$GBET',
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 12),
              const Text(
                'Your \$GBET chips have been burned and USDC sent to your wallet.',
