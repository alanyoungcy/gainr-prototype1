...
import 'package:price_bet/features/wallet/widgets/withdraw_modal.dart';
// Removed broken betting imports
        ...
        children: [
          ...
          Consumer(
            builder: (context, ref, _) {
              // Reading real summary metrics from a hypothetical trade history provider
              // For now, mapping zeroes until the Graph indexer feeds this provider
              final activeCount = wallet.isConnected ? 0 : 0;
              final wonCount = wallet.isConnected ? 0 : 0;
              final lostCount = wallet.isConnected ? 0 : 0;
              final totalWinningsValue = wallet.isConnected ? 0 : 0;
              ...
              return Row(
                children: [
                  ...
                  _StatCard(
                      label: 'Winnings',
                      value: '\$GBET ${totalWinningsValue.toString()}',
                      color: Colors.amber),
                ],
              );
            },
