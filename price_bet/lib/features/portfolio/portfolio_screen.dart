    ...
    return GlassmorphicContainer(
      ...
      child: Column(
        children: [
          _tableHeader(),
          _positionRow(
              'MAN_CITY_vs_INTER_UCL', 'YES', '\$5,000', '+12.4%', '42M'),
          _divider(),
          _positionRow(
              'ARSENAL_vs_LIVERPOOL_EPL', 'YES', '\$2,500', '+8.1%', '2H 15M'),
          _divider(),
          _positionRow('RM_vs_BARCA_EL_CLASICO', 'NO', '\$5,000', '-3.2%', '14D'),
          _divider(),
          _positionRow('BUNDESLIGA_TITLE_LEVERKUSEN', 'YES', '\$3,200', '+5.7%', '250D'),
          _divider(),
          _positionRow(
              'SERIE_A_WINNER_INTER', 'YES', '\$1,800', '+4.2%', '248D'),
          _divider(),
          _positionRow(
              'MBAPPE_TRANSFER_REAL_MADRID', 'YES', '\$2,100', '-1.8%', '248D'),
          _divider(),
          _positionRow('SAUDI_PRO_LEAGUE_CHAMPION', 'YES', '\$4,500', '+18.3%', '180D'),
          _divider(),
          _positionRow('AFCON_WINNER_NIGERIA', 'YES', '\$1,200', '-6.4%', '150D'),
          _divider(),
          _positionRow('MLS_CUP_WINNER_MIAMI', 'NO', '\$3,800', '+2.9%', '60D'),
          _divider(),
          _positionRow('NATIONS_LEAGUE_FINALIST', 'YES', '\$900', '+22.1%', '300D'),
          _divider(),
          _positionRow(
              'WORLD_CUP_2026_HOST_CITIES', 'DONE', '\$2,700', '-8.5%', '120D'),
        ],
      ),
    );
  }
